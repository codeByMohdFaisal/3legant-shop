        ...
        <div className="home-page-container">
          ...
          <div className="product-details-description">
            <div className="product-details-top-desc-div">
              <RatingBox />
              <p className="product-details-title">Tray Table</p>
      ...
      <section className="customer-section">
        <div className="home-page-container">
          ...
          <div className="customer-review-div">
            ...
            <div className="rating-reviews-parent-div">
              <RatingBox />
              <p className="number-of-reveiw-text">11 Reviews</p>
            </div>
          ...
          <div className="customer-reviews-list-parent-div">
            <div className="customer-reviews-list-parent-top-div">
              <p className="review-top-heading">11 Reviews</p>
